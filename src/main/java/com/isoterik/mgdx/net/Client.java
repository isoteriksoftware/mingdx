 ...
 * to a Hub.  The client is used for sending messages to the
...
public abstract class Client
{
     ...
     * sent. Set to true by default.
     */
    private volatile boolean autoreset = true;
     ...
     * @param message message received from the Hub
     */
     ...
     * @param message The message will be "*shutdown*" if the message was in fact
     * sent by a Hub that is shutting down in the normal way.
     */
     ...
     * connection setup.)
     * @return the ID number of this client
     */
    public int getID() {
     ...
     * @param auto should be true to enable auto reset, false otherwise
     */
     ...
     * @return true auto reset is enabled, false otherwise
     */
