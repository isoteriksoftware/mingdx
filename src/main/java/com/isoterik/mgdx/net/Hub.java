...
/**
 * A Hub is a server for a game.  When a Hub is created, it will
 ...
 * the package mgdx.net, are for internal use only.  These messages
...
public class Hub {
     ...
     */
    public void restartListening(int port) throws IOException {
     ...
     *  been called, by calling the restartListening() method.
     */
