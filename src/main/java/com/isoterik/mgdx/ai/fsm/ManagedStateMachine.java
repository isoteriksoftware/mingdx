 ...
 * Only the global state can be changed, the state machine uses given {@link Transition}s to determine the current state and the next state.
 ...
 * evaluated from first to last. If more than one {@link Transition} is triggered, the first to be evaluated will determine the current state, others are ignored!
 *
